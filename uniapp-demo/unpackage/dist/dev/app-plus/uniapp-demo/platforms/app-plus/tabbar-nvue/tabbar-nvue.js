...
__vue_options__.__file = "/Users/gyl-dev/working/xiangliang/uniapp-demo/uniapp-demo/components/tab-nvue/tabContent.nvue"
...
__vue_options__.__file = "/Users/gyl-dev/working/xiangliang/uniapp-demo/uniapp-demo/platforms/app-plus/tabbar-nvue/tabbar-nvue.nvue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c46e2cde"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
//
//
var dom = weex.requireModule('dom');exports.default = { components: { tabContent: _tabContent2.default, tabBar: _tabBar2.default, tabs: _tabs2.default, mediaList: _mediaList2.default }, created: function created() {var _this = this;setTimeout(function () {_this.newsitems = _this.randomfn();}, 150);}, data: function data() {return { refreshing: false, current_rotate: 0, refreshText: "下拉可以刷新", tabIndex: 0, newsitems: [], data0: { "datetime": "40分钟前", "article_type": 0, "title": "uni-app行业峰会频频亮相，开发者反响热烈!", "source": "DCloud",
				"comment_count": 639 },
	...
	methods: {
		...
		onrefresh: function onrefresh(event) {var _this2 = this;
			uni.showToast({
				title: "refresh",
				icon: "none" });
		...
		close: function close(index1, index2) {var _this4 = this;
			uni.showModal({
				...
				success: function success(res) {
					if (res.confirm) {
						_this4.newsitems[index1].data.splice(index2, 1);
					}
				} });

		},
		changeTab: function changeTab(e) {var _this5 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {var el, elSize, index, newEl;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
								_this5.tabIndex = e.index;
								el = _this5.$refs[_this5.tabBars[e.index].id + e.index][0];_context.next = 4;return (
									_this5.getElSize(el));case 4:elSize = _context.sent;if (!(
								elSize.left + elSize.width > 750)) {_context.next = 10;break;}
								index = e.index - 4;
								newEl = _this5.$refs[_this5.tabBars[index].id + index][0];
								dom.scrollToElement(newEl, {});return _context.abrupt('return');case 10:


								if (elSize.left < 0) {
									dom.scrollToElement(el, {});
								}case 11:case 'end':return _context.stop();}}}, _callee, _this5);}))();
		},
...
storage.getItem(UNIAPP_LAUNCH_WEBVIEW_ID, function (evt) {
...
function request(_ref) {
  ...
  stream.fetch({
    ...
    body: serialize(data, method, headers['Content-Type']) },
  function (_ref2) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default =
{
    ...
    watch: {
        index: function index(oldV, newV) {
...
__vue_options__.__file = "/Users/gyl-dev/working/xiangliang/uniapp-demo/uniapp-demo/components/tab-nvue/tabBar.nvue"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/gyl-dev/working/xiangliang/uniapp-demo/uniapp-demo/components/tab-nvue/tabs.nvue"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/gyl-dev/working/xiangliang/uniapp-demo/uniapp-demo/components/tab-nvue/mediaList.nvue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6989774c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
/***/ })
/******/ ]);
//# sourceMappingURL=tabbar-nvue.js.map?edea0454ef9d571d2e1a